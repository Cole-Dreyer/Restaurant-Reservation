...
function Table() {
  // Acquire useHistory to assist with page navigation
  ...
  function loadTable() {
    ...
    setTableError(null);
    listTables(abortController.signal).then(setTable).catch(setTableError);
              ...
              <td>
                ...
                {tbl.reservation_id ? (
                  <button
                    ...
                    onClick={() =>
                      handleClearTable(tbl.table_id, tbl.reservation_id)
                    }
                  >
                    Finish
                  </button>
